...
import com.example.devjams.OutputActivity;
...
public class ArticleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView c = (CardView)findViewById(R.id.key_out);
        c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ArticleActivity.this, OutputActivity.class);
                i.putExtra("value",keys);
                startActivity(i);
            }
        });
